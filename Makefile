...
SRCDIR	:= ./srcs/
SRC	:= push_swap.c quick_sort_asce.c quick_sort_desc.c push_swap_init.c deque.c clear_deque.c deque_util.c pop_deque.c shift_deque.c ab_table.c swap_ab_table.c rotete_ab_table.c reverse_ab_table.c divide_ab_table.c ab_table_util.c push_swap_util.c can_shift.c can_rotate.c divide_ab_table_util.c
ENTRY	:= main.c
